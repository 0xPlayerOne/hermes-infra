...
1. **Discord** — DM NiftyAndy (`0xPlayerOne`) directly in the [Hermes Infra Discord](https://discord.gg/niftyleague)
...
- The reporter and the Hermes Infra team coordinate disclosure.
...
This policy covers all code in the `0xPlayerOne/hermes-infra` repository, including all apps and packages within the monorepo.  
